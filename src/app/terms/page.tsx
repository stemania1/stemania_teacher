...
export const metadata: Metadata = {
  title: "Terms of Service - STEMania Teacher",
  description: "Terms of Service for STEMania Admin and STEMania Teacher.",
};

export default async function TermsPage() {
  const docsPath = path.join(process.cwd(), "docs", "terms-of-service.md");
